...
# the working dir, not the script's location.
#
...
#   bin/ship/pre-sync.sh                     # (in shared repo)
#   infra/shared/bin/ship/pre-sync.sh        # (in consumer repo)
#
# Exit code : 0 if safe to reset, 1 otherwise.
#
# Checks :
